      ...
      <section className="mt-8">
        ...
        <div className="mt-12">
          <p>
            ...
            Compétences clés : Front-end (React, Next, Tailwind, Chakra, Redux), Back (Node.js, GraphQL, Nest) et Cloud & DevOps (AWS, Docker, Serverless)
            Forte expertise en architecture logicielle
          </p>
        </div>
